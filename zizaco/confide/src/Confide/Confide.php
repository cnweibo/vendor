...
class Confide
{
    ...
    protected function loginThrottling($identity)
    {
        ...
        if ($count >= config('confide.throttle_limit')) {
            return false;
        }
    ...
    {
        return $this->app->make('view')->make(config('confide.login_form'));
    }
    ...
    {
        return $this->app->make('view')->make(config('confide.signup_form'));
    }
    ...
    {
        return $this->app->make('view')->make(config('confide.forgot_password_form'));
    }
